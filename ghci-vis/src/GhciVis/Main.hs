...
module GhciVis.Main (main) where
...
#ifdef GHCI
import GhciVis.InteractiveUI    ( interactiveUI, ghciWelcomeMsg, defaultGhciSettings )
#endif
...
main = do
   ...
   GHC.defaultErrorHandler defaultFatalMessager defaultFlushOut $ do
    ...
    let argv1' = map (mkGeneralLocated "on the commandline") ("--interactive" : argv1)
